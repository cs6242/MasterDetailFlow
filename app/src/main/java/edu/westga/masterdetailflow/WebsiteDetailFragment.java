...
public class WebsiteDetailFragment extends Fragment {
     ...
     */
    private WebsiteData.WebsiteItem mItem;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if (getArguments().containsKey(ARG_ITEM_ID)) {
            ...
            mItem = WebsiteData.ITEM_MAP.get(getArguments().getString(ARG_ITEM_ID));
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        // Show the site in a WebView.
        if (mItem != null) {
            ((WebView) rootView.findViewById(R.id.website_detail)).loadUrl(mItem.getUrl());
        }
